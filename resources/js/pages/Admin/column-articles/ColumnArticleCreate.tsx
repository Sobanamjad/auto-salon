...
import {
    ...
    FaSort, FaCalendar, FaTag, FaSearch, FaTimesCircle,
} from 'react-icons/fa';

export default function ColumnArticleCreate() {
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h2 className="text-2xl font-bold text-gray-800 flex items-center gap-2">
                                <FaPencilAlt className="text-blue-500" /> 新增專欄文章
                            </h2>
                            <p className="text-sm text-gray-500 mt-1">建立新的專欄文章</p>
                        </div>
                    </div>
                        ...
                        <div className="flex items-start gap-4">
                            ...
                            {previewUrl ? (
                                <div className="relative shrink-0">
                                    <img src={previewUrl} alt="預覽" className="w-32 h-32 object-cover rounded-lg border border-gray-300" />
                                ...
                                <div className="w-32 h-32 border-2 border-dashed border-gray-300 rounded-lg flex items-center justify-center text-gray-400 shrink-0">
                                    <FaImage size={24} />
                                </div>
                            )}
                            <div className="flex-1">
                                ...
                                <p className="text-xs text-gray-500 mt-2">支援 JPEG、PNG、GIF，最大 5MB</p>
