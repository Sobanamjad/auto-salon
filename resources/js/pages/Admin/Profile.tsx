...
export default function Profile({ title = '個人資料', user, isEdit = true }: Props) {
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="bg-gray-50 rounded-lg p-6 border border-gray-200">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div className="md:col-span-2">
                                ...
                                {data.line_message_status === 1 && (
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mt-3 p-3 bg-white rounded border">
                                        ...
                                        <div>
                                            <label className="block text-xs text-gray-600">頻道密鑰</label>
                                            <input
                                                type="text"
                                        ...
                                        <div>
                                            <label className="block text-xs text-gray-600">使用者 ID</label>
                                            <input
                                                type="text"
                            ...
                            <div>
                                <label className="block text-sm font-medium text-gray-700 mb-1 flex items-center gap-2">
                                    <FaWeixin className="text-green-500" /> WeChat
                                </label>
                                <input
                                    type="text"
                                    value={data.wechat}
                            ...
                            <div>
                                <label className="block text-sm font-medium text-gray-700 mb-1 flex items-center gap-2">
                                    <FaSkype className="text-blue-500" /> Skype
                                </label>
                                <input
                                    type="text"
                            ...
                            <div>
                                <label className="block text-sm font-medium text-gray-700 mb-1 flex items-center gap-2">
                                    <FaGlobe className="text-red-500" /> Weibo
                                </label>
                                <input
                                    type="text"
                                    value={data.weibo}
                    ...
                    <div className="bg-gray-50 rounded-lg p-6 border border-gray-200">
                        <h3 className="text-lg font-semibold text-gray-800 mb-4 flex items-center gap-2">
                            <FaMapMarkerAlt className="text-red-500" /> 地址資訊
                        </h3>
                        <div>
                    ...
                    <div className="bg-gray-50 rounded-lg p-6 border border-gray-200">
                        <h3 className="text-lg font-semibold text-gray-800 mb-4 flex items-center gap-2">
                            <FaBuilding className="text-indigo-500" /> 商業資訊
                        </h3>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                            ...
                            <div>
                                <label className="block text-sm font-medium text-gray-700 mb-1 flex items-center gap-2">
                                    <FaClock className="text-gray-500" /> 營業時間
                                </label>
                                <input
                                    type="text"
                            ...
                            <div>
                                <label className="block text-sm font-medium text-gray-700 mb-1 flex items-center gap-2">
                                    <FaUniversity className="text-gray-500" /> 銀行帳號
                                </label>
                                <input
                                    type="text"
                                    value={data.bank}
                    ...
                    <div className="bg-gray-50 rounded-lg p-6 border border-gray-200">
                        <h3 className="text-lg font-semibold text-gray-800 mb-4 flex items-center gap-2">
                            <FaInfoCircle className="text-gray-500" /> 其他資訊
                        </h3>
                        <div>
                    ...
                    <div className="bg-gray-50 rounded-lg p-6 border border-gray-200">
                        <h3 className="text-lg font-semibold text-gray-800 mb-4 flex items-center gap-2">
                            <FaTag className="text-orange-500" /> 廣告設定
                        </h3>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                            ...
                            <div>
                                <label className="block text-sm font-medium text-gray-700 mb-1">廣告連結</label>
                                <input
                                    type="text"
                                    value={data.ad_url}
