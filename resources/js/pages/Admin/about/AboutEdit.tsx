...
export default function AboutEdit({ about }: { about: About }) {
    const { data, setData, put, processing, errors } = useForm<AboutFormData>({
        language: about.language,
        status: about.status,
        show_on_home: about.show_on_home,
        ...
        video: about.video || '',
        note: about.note || '',
        issuedate: about.issuedate || new Date().toISOString().split('T')[0],
        enddate: about.enddate || '2200-12-31'
    });

    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        put(`/admin/about/${about.id}`, {
            onSuccess: () => {
            ...
            <div className="bg-white rounded-xl shadow-sm p-6">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h2 className="text-2xl font-bold text-gray-800 flex items-center gap-2">
                                <FaInfoCircle className="text-blue-500" /> 關於本會 - 編輯資料
                            </h2>
                            <p className="text-sm text-gray-500 mt-1">編輯介紹內容 #{about.id}</p>
                        </div>
                    </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="bg-gray-50 rounded-lg p-4">
                        ...
                        {about.image && (
                            <div className="mb-3">
                                <p className="text-sm text-gray-600 mb-1">目前相片:</p>
                                <img 
                                    src={about.image} 
                                    alt={about.subject} 
