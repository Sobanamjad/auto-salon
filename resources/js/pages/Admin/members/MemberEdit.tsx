...
export default function MemberEdit({ member, title }: Props) {
    const { data, setData, put, processing, errors } = useForm({
        ...
        category2: member.category2 || '',
        member_type: member.member_type || '',
        position_in_association: member.position_in_association || '',
        affiliated_unit: member.affiliated_unit || '',
        period_start: member.period_start || '',
        period_end: member.period_end || '',
        fee: member.fee || '',
        note: member.note || '',
        sort_order: member.sort_order || 99,
                ...
                <div className="flex items-center justify-between border-b border-gray-200 pb-4 mb-6">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-500 mt-1">編輯會員 #{member.id}</p>
                        </div>
                    </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="bg-gray-50 rounded-lg p-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div>
                                <label className="block text-sm font-medium text-gray-700 mb-1">
                                    <FaUserCog className="inline mr-1" /> 新密碼
                                </label>
                                <input
                                    type="password"
                                    value={data.password}
                                    ...
                                    placeholder="留空則不修改"
                                />
                                <p className="text-xs text-gray-500 mt-1">留空則不修改密碼</p>
                            </div>
